      ...
      <div className="flex items-center gap-5.5 text-lg text-white mr-7 z-20">
        {navItems.map((item) => (
          <button
            ...
            className="relative px-6 py-1.5 cursor-pointer  rounded-[50%] transition-all duration-300 ease-out hover:bg-[#6be5be]/40 hover:border-[#6be5be]/65 hover:shadow-[0_8px_32px_rgba(107,229,190,0.25)] hover:-translate-y-0.5 active:translate-y-0"
          >
